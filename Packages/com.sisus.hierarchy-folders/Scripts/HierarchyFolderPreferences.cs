...
namespace Sisus.HierarchyFolders
{
	...
	public class HierarchyFolderPreferences : ScriptableObject, ISerializationCallbackReceiver
	{
		...
		private void OnEnable() => HandleLoadDefaultIconsIfNull();

        private void HandleLoadDefaultIconsIfNull()
		{
			...
			if(modernDark.closed == null)
			{
				if(EditorApplication.isUpdating)
				{
					...
					#endif
					EditorApplication.delayCall += HandleLoadDefaultIconsIfNull;
					return;
				}
